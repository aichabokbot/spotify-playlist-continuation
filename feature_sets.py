...
def get_all_features(MAX_PLAYLIST_LENGTH):
    ...
    feats = {
        ...
        'num_tracks_pl' : tf.io.FixedLenFeature(dtype=tf.float32, shape=()),  # num_pl_songs_new | n_songs_pl_new
        ...
        # Float List
        "duration_ms_pl": tf.io.FixedLenFeature(dtype=tf.float32, shape=(MAX_PLAYLIST_LENGTH,)), 
        ...
        "artist_followers_pl": tf.io.FixedLenFeature(dtype=tf.float32, shape=(MAX_PLAYLIST_LENGTH,)),
