    ...
    def call(self, data):
        ...
        all_embs = tf.concat(
            [
                ...
                self.pl_name_src_text_embedding(data['name_pl']),
                self.pl_collaborative_src_embedding(data['collaborative_pl']),
                # self.num_pl_followers_src_embedding(data["num_pl_followers_src"]),
                self.pl_duration_ms_new_embedding(data["total_duration_ms_pl"]),
                self.num_pl_songs_new_embedding(data["num_tracks_pl"]), # num_pl_songs_new | n_songs_pl_new
                self.num_pl_artists_new_embedding(data["num_artists_pl"]),
                self.num_pl_albums_new_embedding(data["num_albums_pl"]),
                ...
                self.duration_ms_songs_pl_embedding(data["duration_ms_pl"]),
